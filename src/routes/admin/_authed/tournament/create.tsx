...
import { createTournament } from "~/server/functions/tournament";
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="font-semibold text-gray-900">Select from Player Database</h2>
...
Alice Brown,650000,Blue,C`}
              className="w-full h-48 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm"
            />
          </CardContent>
        </Card>
...
Spencer Craft,021 174 7700,850000`}
        ...
        <details className="group">
          <summary className="cursor-pointer text-sm font-medium text-gray-700 hover:text-gray-900 py-2 list-none flex items-center gap-2">
            <svg
